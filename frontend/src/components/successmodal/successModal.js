...
export default function SuccessModal(){
    return(
        <div className="ComponentOne">
            <button type="button" className="btn btn-info btn-lg" data-toggle="modal" data-target="#success_tic">Open
                Modal
            </button>
            <MDBModal show={true} id="success_tic" className="modal fade" role="dialog">
