...
export default function ForgotPassword(props) {
    ...
    const handleChange = event =>
        setUserForgotPassword({ ...userForgotPassword, [event.target.name]: event.target.value });
        ...
        <>
            <div>
                ...
                <Modal open={open} onClose={handleClose}>
                    <Box sx={{ position: 'absolute', width: 400, height: 500,top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}>
                        <div
