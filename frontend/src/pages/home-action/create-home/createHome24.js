                ...
                <div className="col-7">
                    ...
                    <div style={{width:500, marginLeft:"30px"}}>
                        ...
                        <InputGroup className="mb-3">
                            ...
                            <Form.Control as="input" type='number' min="1" onChange={(e) => {
            ...
            <div className="row">
                <div className="col-12">
                    ...
                    {descriptions && titles && prices ? (
                        <Button variant="contained" id="btn-finish1" onClick={handleFinish}>Finish</Button>
                    ) : (
                        <Button type='button' id="btn-finish2" variant="contained">Finish</Button>
                    )}
                </div>
            </div>
        </>
