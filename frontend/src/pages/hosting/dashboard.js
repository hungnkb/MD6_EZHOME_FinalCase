...
function DashboardHosting() {
    ...
    return (
        <>
            ...
            }} style={{background: '#f7a800', marginLeft: '1100px'}} variant="contained"> +Add home</Button>
            <hr/>
                ...
                <Table sx={{minWidth: 650}} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="center"><b>Bathrooms </b> </TableCell>
                            <TableCell align="center"><b> Bedrooms</b> </TableCell>
                            <TableCell align="center"><b>Description </b> </TableCell>
                            <TableCell align="center"> <b>Price (đ) </b> </TableCell>
                    ...
                    <TableBody>
                        {homeList
                            ? homeList.map((data, index) => (
                                ...
                                >
                                    <TableCell component="th" scope="row"><b>  {index + 1} </b>
                                    </TableCell>
                                    ...
                                    <TableCell align="center"><i className="fa-solid fa-pen-to-square" style={{
                                        color: "green",
                                        fontSize: "130%"
                                    }}></i></TableCell>
                                    <TableCell align="center"><i className="fa-solid fa-trash" style={{
                                        color: "red",
                                        fontSize: "130%"
                                    }}></i></TableCell>
                                </TableRow>
